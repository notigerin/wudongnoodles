    ...
    <form action="/column/insert" method="post" class="form form-horizontal" id="form-category-add">
            ...
            <div class="tabCon">
                ...
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3">
                        <span class="c-red">*</span>
                        栏目名称：</label>
                    <input type="hidden" id="columnId" name="columnId" value="${columns.columnId}" />
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${columns.columnName}" placeholder="" id="columnName" name="columnName" />
                    </div>
                    <div class="col-3">
                    </div>
                </div>
        ...
        <div class="row cl">
            <div class="col-9 col-offset-3">
                <input id="modifyColumn" class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
            </div>
        </div>
    </form>
</div>
