package com.ddc.server.config.web;

import com.ddc.server.annotation.AccessLimit;
import com.ddc.server.annotation.Log;
import com.ddc.server.annotation.ParamXssPass;
import com.ddc.server.annotation.ValidationParam;
import com.ddc.server.aspect.*;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(* com.ddc.server.controller..*(..))  ")
    public void aspect() {
    }
